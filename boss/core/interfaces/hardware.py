"""
Hardware abstraction interfaces (relocated to boss.core.interfaces).
"""

from abc import ABC, abstractmethod
from typing import Dict, Any, Optional, Callable
from boss.core.models import LedColor, ButtonColor, LedState, ButtonState, DisplayState, SwitchState
...
class HardwareFactory(ABC):
    ...
    # Optional hooks for dev UI parity
